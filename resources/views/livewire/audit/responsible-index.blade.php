<div>
    ...
    <x-audit-pengelolaan :audit=$audit menu="responsible">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ $statusModal }} Pimpinan Auditi</h5>
    ...
    @push('after-scripts')
        <script>
            ...
            window.livewire.on('responsibleUpdated', () => {
                $('.openModal').modal('hide');
            });

            window.livewire.on('editResponsible', (value) => {
